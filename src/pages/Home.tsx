...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Fixed footer */}
      <footer className="fixed bottom-0 inset-x-0 h-10 bg-panel/95 backdrop-blur-sm border-t border-line z-10 flex items-center justify-between px-4 sm:px-6">
      ...
      {/* Contact modal */}
      {contactOpen && (
        <Modal title="Murojat qilish" onClose={() => setContactOpen(false)} width={380}>
          <div className="space-y-4">
            <div className="flex items-start gap-3 rounded-xl bg-amber-50 border border-amber-200 px-4 py-3">
              <span className="text-amber-500 text-lg leading-none mt-0.5">⚠</span>
              <p className="text-[13px] text-amber-900 leading-relaxed">
                Dasturda xatolik, kamchilik yoki taklifingiz bo'lsa — Telegram orqali bog'lanishingiz mumkin.
              </p>
            </div>
            ...
            <a
              ...
              className="flex items-center justify-center h-10 rounded-xl bg-ink text-paper text-[13px] font-medium hover:bg-ink/90 transition w-full"
            >
